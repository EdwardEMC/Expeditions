import {WebXRButton} from '/assets/webxr/util/webxr-button.js';
import {Scene} from '/assets/webxr/render/scenes/scene.js';
import {Renderer, createWebGLContext} from '/assets/webxr/render/core/renderer.js';
import {InlineViewerHelper} from '/assets/webxr/util/inline-viewer-helper.js';
...
export class WebXR {
  constructor(options) {
    ...
    this.frameCallback = (time, frame) => {
      ...
      // keep for now incase extra functionality is needed later
  ...
  onSessionStarted(session) {
    ...
    session.addEventListener('select', this.pointer);

    // enable selecton of icons
  ...
  toggleOptions() {
    console.log("Hide text for guide");
  }
}